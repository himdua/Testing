...
public class GlobalEnumsPage {
	...
	public enum AddProductField {
		FLAT, LINEPERCENTAGE, ASSETMANAGEMENT, GRADUATED, DESCRIPTION, FLATPRICE, GRADUATEDPRICE, GRADUATECAPPRICE, TIMEOFDAY, TIERED, VOLUME, POOLED, ITEMPAGESELECTOR, ITEMSELECTOR, QUANTITYADON, COMPANYPOOLED, FLAT_PERCENTAGE, FLAT_DATE, FLATPRICEWITHCURRENTCOMPANY, LINEPERCENTAGEWITHCOMPANY, FLATPRICEWITHGLOBAL, ADDPRODUCTWITHASSETMANAGEMENT;
	}

	public enum AddMetaDataFields {
		DATA_FIELD, DATA_TYPE, DATA_DEFAULT_VALUE, NewAssetMetafield, NewAssetMetafieldWITHOUTDEFAULT;
	}
	...
	public enum AddPlanField {
		ALL, DETAILS, PRODUCT, BUNDLEDPERIOD, PLANPERIOD, MULTIPLEPLAN, WITHNOTE, INCLUDEQUANTITY, WITHOUTPRODUCTRATE, FLATPRICE, ONEPRODUCT, FLATPRICEWITHRATE, FLATPRICEWITHFOURPRODUCT, NEWPLANWITHDATE, HISTORICPLAN;
	}
	...
	public enum CreateOrder {
		CHANGESTATUS, PLANWITHSTATUS, ONETIME;
	}

	public enum EditOrder {
		CHANGEQUANTITY, EFFECTIVEDATEANDQUANTITY, CHANGESTATUS, PLANEDIT;
	}

	public enum MakePayment {
		MODIFYPAYMENT, UNCHANGEDPAYEMENT;
	}
}
