...
public class ConfigurationPage {
	...
	@LocateBy(id = "currencies.7.inUse")
	private ElementField CHK_Swiss_Franc;

	@LocateBy(id = "currencies.3.inUse")
	private ElementField CHK_Euro;

	@LocateBy(id = "currencies.4.inUse")
	private ElementField CHK_Yen;

	@LocateBy(id = "currencies.5.inUse")
	private ElementField CHK_Pound_Sterling;

	@LocateBy(id = "currencies.6.inUse")
	private ElementField CHK_Won;

	@LocateBy(id = "currencies.3.rate")
	private ElementField TXT_Currency_Euro;

	@LocateBy(id = "currencies.6.rate")
	private ElementField TXT_Currency_Won;

	@LocateBy(id = "currencies.4.rate")
	private ElementField TXT_Currency_Yen;

	@LocateBy(id = "currencies.5.rate")
	private ElementField TXT_Currency_Pound;

	@LocateBy(id = "defaultCurrencyId")
	private ElementField DP_Currency_Default;

	@LocateBy(xpath = "//span[text()='Save Changes']")
	private ElementField LT_Save_generic;

	@LocateBy(xpath = "//span[text()= 'Create Reseller']")
	private ElementField bttn_createreseller;

	@LocateBy(xpath = "//input[@id='user.userName']")
	private ElementField txt_Loginname;

	@LocateBy(xpath = "//input[@id='contact.firstName']")
	private ElementField txt_Firstname;

	@LocateBy(xpath = "//input[@id='contact.lastName']")
	private ElementField txt_Lasttname;

	@LocateBy(xpath = "//input[@id='contact.phoneCountryCode1']")
	private ElementField txt_Firstphone;

	@LocateBy(xpath = "//input[@id='contact.phoneAreaCode']")
	private ElementField txt_PhoneAreaCode;

	@LocateBy(xpath = "//input[@id='contact.phoneNumber']")
	private ElementField txt_ContactPhoneNumber;

	@LocateBy(xpath = "//input[@id='contact.email']")
	private ElementField txt_Email;

	@LocateBy(xpath = "//input[@id='contact.organizationName']")
	private ElementField txt_Organization;

	@LocateBy(xpath = "//input[@id='contact.address1']")
	private ElementField txt_Address1;

	@LocateBy(xpath = "//input[@id='contact.stateProvince']")
	private ElementField txt_StateProvince;

	@LocateBy(id = "contact.countryCode")
	private ElementField drp_ConuntryCode;

	@LocateBy(xpath = "//input[@id='contact.postalCode']")
	private ElementField txt_ZipPostalCode;

	@LocateBy(xpath = " //span[text()='Save Changes']")
	private ElementField bttn_SaveChangesSeller;

	@LocateBy(xpath = "//span[text()='Create Reseller']")
	private ElementField bttn_CreateSeller;
	...
	private ElementField bttn_Delete_AITType;

	@LocateBy(xpath = "//span[text() = 'Yes']")
	private ElementField bttn_delte_AITType;

	@LocateBy(xpath = "//table[@id='categories']/tbody/tr/td/a/strong")
	private ElementField lnk_payment;

	@LocateBy(xpath = "//span[text()='Add Notification']")
	private ElementField bttn_AddPaymentNotification;

	@LocateBy(xpath = "//input[@id ='description']")
	private ElementField txt_AddPaymentNotificationdec;

	@LocateBy(xpath = "//span[text()='Save Changes']")
	private ElementField bttn_NotificationSaveChanges;

	@LocateBy(xpath = "//div[@id='notification-box']/div[@class='table-box']/table/tbody/tr[1]/td[1]/a//em")
	private ElementField lnk_recent_Notification;

	@LocateBy(xpath = "//span[text()='Edit']")
	private ElementField bttn_Edit_PaymentNotification;

	@LocateBy(id = "mediumTypes")
	private ElementField lst_Payment_value;

	@LocateBy(xpath = "//ul[@class='top-nav']/li[1]")
	private ElementField lb_Comapnyname;

	@LocateBy(xpath = "//span[contains(text(),'Add New')]")
	private ElementField BT_ADDNEW;

	@LocateBy(xpath = "//input[@id='validTo']")
	private ElementField TB_VALIDTO;

	@LocateBy(xpath = "//input[@id='identifier']")
	private ElementField TB_USER_CODE;

	@LocateBy(xpath = "//textarea[@id='typeDescription']")
	private ElementField TA_DESCRIPTION;

	@LocateBy(xpath = "//table[@id='users']/tbody/tr/td/a/strong")
	private ElementField TAB_USER;

	@LocateBy(xpath = "//select[@id='type']")
	private ElementField DD_TYPE;

	@LocateBy(xpath = "//input[@id='user.userName']")
	private ElementField TB_USER_LOGIN;

	@LocateBy(xpath = "//input[@id='contact.email']")
	private ElementField TB_EMAIL;

	@LocateBy(xpath = "//input[@id='contact.include']")
	private ElementField CB_INCLUDE_NOTIFICATION;

	@LocateBy(xpath = "//span[contains(text(),'Permissions')]")
	private ElementField BT_PERMISSIONS;

	@LocateBy(xpath = "//span[contains(text(),'User Codes')]")
	private ElementField BT_USER_CODE;

	@LocateBy(xpath = "//label[contains(text(),'View User Code')]/preceding-sibling::input[1]")
	private ElementField CB_VIEW_USER_CODE;

	@LocateBy(xpath = "//label[contains(text(),'Edit User Code')]/preceding-sibling::input[1]")
	private ElementField CB_EDIT_USER_CODE;

	@LocateBy(xpath = "//label[contains(text(),'Modify User Code for Entity')]/preceding-sibling::input[1]")
	private ElementField CB_MODIFY_USER_CODE;

	@LocateBy(xpath = "//label[contains(text(),'Assign User Code to Entity')]/preceding-sibling::input[1]")
	private ElementField CB_ASSIGN_USER_CODE;

	@LocateBy(xpath = "//label[contains(text(),'Add User Code')]/preceding-sibling::input[1]")
	private ElementField CB_ADD_USER_CODE;

	@LocateBy(xpath = "//table[@id='users']/tbody/tr[1]/td[1]/a/strong")
	private ElementField ADDED_USER_CODE;

	@LocateBy(xpath = "//a[contains(text(),'Order Change Types')]")
	private ElementField LT_ORDER_CHANGE_TYPE;

	@LocateBy(xpath = "//input[@id='name']")
	private ElementField ORDER_STATUS_TYPE_NAME;

	@LocateBy(xpath = "//input[@id='allowOrderStatusChange']")
	private ElementField CB_ALLOW_ORDER_STATUS_CHANGE;

	@LocateBy(xpath = "//select[@id='itemTypes_selector']")
	private ElementField DD_CATEGORY;

	@LocateBy(xpath = "//input[@id='startDate']")
	private ElementField TB_STARTDATE;

	@LocateBy(xpath = "//input[@id='priceExpiryDate']")
	private ElementField TB_EXPIRYDATE;

	@LocateBy(xpath = "//a[contains(text(), 'Payment Method')]")
	private ElementField LT_PAYMENT_METHOD;

	@LocateBy(xpath = "//div[@class='inp-bg ']/input[@id='methodName']")
	private ElementField TXTPAYMENT_METHODNAME;

	@LocateBy(xpath = "//li/a[contains(text(), 'Blacklist')]")
	private ElementField LT_BLACKLIST;

	@LocateBy(xpath = "//div[@class='inp-bg ']/input[@id='filterBy']")
	private ElementField TXT_SEARCH_CUSTOMER;

	@LocateBy(xpath = "//td/a")
	private ElementField TXT_VERIFYBLACKLISTEDCUSTOMER;

	@LocateBy(xpath = "//td/a[contains(text(), '************1152')]")
	private ElementField TXT_CREDITCARD;

	@LocateBy(xpath = "//table[@id='periods']//tbody//td/a/strong")
	private ElementField TAB_ACCOUNTTYPE;

	@LocateBy(xpath = "//span[contains(text(), 'Delete')]")
	private ElementField BT_DELETEACCOUNTTYPE;

	@LocateBy(xpath = "//table/tbody/tr/td[2]/p[starts-with(@id,'confirm-dialog-delete')]")
	private ElementField CONF_MSGVERIFY;

	@LocateBy(xpath = "//span[contains(text(), 'No')]")
	private ElementField BTN_CONFIRM_NO;

	@LocateBy(xpath = "//input[@id='displayOrder']")
	private ElementField AIT_DISPLAYORDER;

	@LocateBy(xpath = "//tr/td/a/strong[contains(text(), 'ACCOUNT_TYPE')]")
	private ElementField LNK_ACCOUNTTYPE;

	@LocateBy(xpath = "//a[contains(text(), 'Import Metafields')]")
	private ElementField LNK_IMPORTMETAFIELDS;

	@LocateBy(xpath = "//table[@id='metafields']//tbody//td/a/span")
	private ElementField TAB_IMPORTMETAFIELD;

	@LocateBy(xpath = "//li[@class='mf  active']")
	private ElementField TXT_ADDNEWMETA;

	@LocateBy(xpath = "//li/a[contains(text(), 'Meta Fields')]")
	private ElementField LT_METAFIELDS;

	@LocateBy(xpath = "//td/a/strong[contains(text(), 'ASSET')]")
	private ElementField LT_ASSET;

	@LocateBy(xpath = "//div/input[@id='metaField.displayOrder']")
	private ElementField TB_ORDERDISPLAY;
	 ...
	 * @param category
	 * @param paymentMethodNameOne
	 * @return
	 * @throws Exception
	 */
	public String newAccountTypeMethod(String testDataSetName, String category, String paymentMethodNameOne) throws Exception {
	...
	/**
	 * @author Syed
	 * @Descrption This method will set the display order
	 */
	protected ConfigurationPage setOrderDisplayMetaFields(String OrderDisplay) throws Exception {
		GlobalController.brw.setText(this.AIT_DISPLAYORDER, OrderDisplay);
		// GlobalController.brw.pressEnter(this.TXT_SEARCH_CUSTOMER);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * @author Syed
	 * @Description This method will Add Information Type in account type
	 */
	public String addAITInPaymemntType(String testDataSetName, String category, String AccountType) throws Exception {
		String infoTypeName = TestData.read("PageConfiguration.xml", testDataSetName, "infoTypeName", category);
		String OrderDisplay = TestData.read("PageConfiguration.xml", testDataSetName, "OrderDisplay", category);

		this.clickAccountTypeLink();
		this.clickAddedAccountType(AccountType);
		this.clickOnAddInformationType();
		this.setAccountTypeInformationTypeName(infoTypeName);
		this.setOrderDisplayMetaFields(OrderDisplay);
		this.clickAddNewMetaField();
		this.addMetaField(infoTypeName, infoTypeName);
	...
	/**
	 * @author Syed
	 * @Description This method will select the account type from account type
	 *              list
	 *
	 */
	protected ConfigurationPage selectAccountTypeFromTable(String accountType) throws Exception {
		GlobalController.brw.selectListItem(this.TAB_ACCOUNTTYPE, accountType);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 *
	 */
	protected ConfigurationPage selectMetaFieldUnderImport(String metaFeild) throws Exception {
		GlobalController.brw.selectListItem(this.TAB_IMPORTMETAFIELD, metaFeild);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * @author Syed
	 * @Description This method will click on Assts link
	 */
	public ConfigurationPage clickOnAssetOption() throws Exception {
		this.ClickOnMetaFields();
		this.ClickOnAssetLink();
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * @author Syed
	 * @Description This method will Click on Asset option in page
	 *
	 * @throws Exception
	 */

	public ConfigurationPage ClickOnAssetLink() throws Exception {
		GlobalController.brw.clickLinkText(this.LT_ASSET);
	...
	/**
	 * @author Syed
	 * @Description This method will Click on Meta Fields option in page
	 *
	 * @throws Exception
	 */

	public ConfigurationPage ClickOnMetaFields() throws Exception {
		GlobalController.brw.clickLinkText(this.LT_METAFIELDS);
		// this.clickAddNewButton();
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	...
	/**
	 * @author Syed
	 * @Description This method will verify the deletion of Used Account Type
	 */
	public ConfigurationPage deleteAccountTypeUsedMethod(String accountName) throws Exception {
		this.clickAccountTypeLink();
	...
	/**
	 * @author Syed
	 * @Description This method will click on "No" button under confirmation
	 *              message throws Exception
	 */
	public ConfigurationPage clickNoLinkOnConfirmationMessage() throws Exception {
		GlobalController.brw.click(this.BTN_CONFIRM_NO);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * @author Syed
	 * @Description This method will verify validation message on deletion of
	 *              Used account type
	 */
	public ConfigurationPage verifyValidationMessageOnDeleteConfirmation() throws Exception {
		boolean result = GlobalController.brw.isElementPresent(this.CONF_MSGVERIFY);
		System.out.println("result" + result);
		if (result == true) {
			ConfigurationPage.logger.debug("Validation Message is displayed");
		} else {
			ConfigurationPage.logger.debug("Validation Message is not displayed");
		}
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * @author Syed This method will Click on MetaFiled Bar
	 *
	 * @throws Exception
	 */

	public ConfigurationPage ClickOnAccountTypeDelete() throws Exception {
		GlobalController.brw.clickLinkText(this.BT_DELETEACCOUNTTYPE);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * @author Syed
	 * @Descrption This method will Click on Blacklist option in page
	 *
	 * @throws Exception
	 */

	public ConfigurationPage ClickOnBlackList() throws Exception {
		GlobalController.brw.clickLinkText(this.LT_BLACKLIST);
		// this.clickAddNewButton();
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	...
	/**
	 * @author Syed
	 * @Description This method will Verify the black listed customer
	 */
	public ConfigurationPage verifyBlackListedCustomerWithDetail(String CustomerName) throws Exception {
	...
	/**
	 * @author Syed
	 * @Descrption This method will verify blackisted customer credit card
	 *             number
	 */
	protected ConfigurationPage VerifyCustomerCreditCard() throws Exception {
		GlobalController.brw.isElementPresent(this.TXT_CREDITCARD);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * @author Syed
	 * @Descrption This method will verify Add New MetaFields number
	 */
	protected ConfigurationPage VerifyAddNewMetaFeilds() throws Exception {
		GlobalController.brw.isElementPresent(this.TXT_ADDNEWMETA);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * @author Syed
	 * @Description This method will verify blacklisted customer name
	 */

	protected ConfigurationPage VerifyCustomerName(String CustomerName) throws Exception {
		String name = GlobalController.brw.getText(this.TXT_VERIFYBLACKLISTEDCUSTOMER);
	...
	/**
	 * @author Syed
	 * @Description This method will set filter for search the customer
	 */
	protected ConfigurationPage setNewFilterInBlackListCustomer(String CustomerName) throws Exception {
		GlobalController.brw.setText(this.TXT_SEARCH_CUSTOMER, CustomerName);
		GlobalController.brw.pressEnter(this.TXT_SEARCH_CUSTOMER);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	...
	/**
	 * @author syed
	 * @Description This method will click on Accoun type link
	 */
	public ConfigurationPage clickAccountTypeLink() throws Exception {
	...
	/**
	 * @author syed
	 * @Description This method will add a payment method
	 */
	public String addPaymentMethod(String testDataSetName, String category, boolean allAccountTypes, boolean isRecurring) throws Exception {
		...
		this.setPaymentMethodName(methodName);
	...
	/**
	 * @author syed
	 * @Descrption This method will set the payment method name
	 *
	 */
	public void setPaymentMethodName(String MethodName) throws Exception {
		// fill ORDER
		GlobalController.brw.setText(this.TXTPAYMENT_METHODNAME, MethodName);

	}

	/**
	 * @author syed
	 * @Description This method will Verify Import metafields with AIT using
	 *              Account type
	 *
	 * @throws Exception
	 */
	public ConfigurationPage importMetafieldsUsingAITWithACCTYPE(String accountType, String metaFeild) throws Exception {
		this.clickAccountTypeLink();
		this.clickAddedAccountType(accountType);
		this.clickOnAddInformationType();
	...
	/**
	 * @author syed
	 * @Description This method will click Payment Method
	 *
	 * @throws Exception
	 */
	protected ConfigurationPage clickOnPaymentMethod() throws Exception {
		GlobalController.brw.clickLinkText(this.LT_PAYMENT_METHOD);
	 ...
	 * @throws Exception
	 */
	protected ConfigurationPage clickPluginAddMoreNameParametersIcon() throws Exception {
	...
	protected ConfigurationPage createValRulOnExpiryDateMF(String dateErrorMsg) throws Exception {
		...
		ConfigurationPage.logger.info("class attribute for cc expiry li element: " + attrVal);
		if (TextUtilities.compareValue("active", attrVal, true, TextComparators.notContains)) {
	...
	public ConfigurationPage setTemplateCompanyName() throws Exception {
		...
		GlobalController.brw.setText(this.TB_TEMPLATE_COMPANY_NAME, templateCompanyName);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	...
	public String getCompanyDescription() throws Exception {
		String companyName = GlobalController.brw.getAttribute(this.TB_COMPANY_DESCRIPTION, "Value");
		return companyName;
	}
	...
	public ConfigurationPage restoreUserPluginPermission(String testDataSetName, String category) throws Exception {
		String environment = this.propReader.readConfig("EnvironmentUnderTest");
		String userName = this.propReader.readConfig(environment + "_Username");
		this.clickSpecifiedUserInUsersTable(userName);
		this.clickUsersPermissionsButton();
	...
	public String addACHPaymentMethod(String testDataSetName, String category) throws Exception {
	...
	public String setNewMetaData(AddMetaDataFields addMetaField, String testDataSetName, String category) throws Exception {
		...
		String displayNumber = TestData.read("PageConfiguration.xml", testDataSetName, "displayNumber", category);
		String MetDataType = TestData.read("PageConfiguration.xml", testDataSetName, "MetDataType", category);
		...
		case NewAssetMetafield:
			this.clickAddNew();
			this.enterNewMetaDataName(Name);
			this.selectDataTypeForNewMataData(MetDataType);
			this.enterOrderDisplayValue(displayNumber);
			this.enterNewMetaDataDefaultValue(Value);
			this.clickOnSaveChanges();
			break;
		case NewAssetMetafieldWITHOUTDEFAULT:
			this.clickAddNew();
			this.enterNewMetaDataName(Name);
			this.selectDataTypeForNewMataData(MetDataType);
			this.enterOrderDisplayValue(displayNumber);
	...
	/**
	 * @author Syed
	 * @Description This method provide Display Order in "New Meta Data" page
	 *
	 * @param Name
	 * @return
	 * @throws Exception
	 */
	protected ConfigurationPage enterOrderDisplayValue(String displayNumber) throws Exception {
		GlobalController.brw.setText(this.TB_ORDERDISPLAY, displayNumber);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	...
	protected ConfigurationPage VerifyPaymentMethodItemIsSelectedInDropdown(String targetValue) throws Exception {
		GlobalController.brw.getDropDownOptionIsSelected(this.DD_PAYMENT_METHOD_TYPE, targetValue);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage setChild_CompanyName(String childCompanyName) throws Exception {
	...
	public String createAccount(String paymentMethod, String testDataSetName, String category) throws Exception {
		String accountName = TestData.read("PageConfiguration.xml", testDataSetName, "accountName", category);
		this.clickAddNewButton();
		this.setAccountTypeName(accountName);
	...
	public ConfigurationPage copyCompany(String testDataSetName, String category) throws Exception {
		boolean childCompany = TextUtilities.compareValue(
				TestData.read("PageConfiguration.xml", testDataSetName, "childCompany", category), "true", true, TextComparators.equals);
	 ...
	 * @param name
	 * @param metaFieldType
	 * @throws Exceptiondrp_Include_in_Notifications
	 */
	...
	protected ConfigurationPage setEnglishName(String englishNameValue) throws Exception {
	...
	protected ConfigurationPage setCyclePeriod(String cyclePeriod) throws Exception {
		GlobalController.brw.setText(this.TB_CYCLE_PERIOD, cyclePeriod);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	protected ConfigurationPage setConsumptionFirstbox(String consumption) throws Exception {
		GlobalController.brw.setText(this.TB_CONSUMPTION1, consumption);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	protected ConfigurationPage setConsumptionSecondbox(String consumption) throws Exception {
	 ...
	 * @author Shashank
	 */
	protected ConfigurationPage setEnumerationValue(SetEnumValues setEnumValues, String enumerationValue) throws Exception {

		switch (setEnumValues) {
		case ZERO:
			GlobalController.brw.setText(this.TB_ZERO_ENUMERATION_VALUE, enumerationValue);
			break;
		case ONE:
			GlobalController.brw.setText(this.TB_FIRST_ENUMERATION_VALUE, enumerationValue);
			break;
		default:
			throw new Exception("Invalid Message Enum provided to work on. Not defined in enumeration");
		}
	...
	public ConfigurationPage selectEnumerationsFromTable(String enumerationName) throws Exception {
		GlobalController.brw.selectListItem(this.TAB_ENUMERATION_FIRST_CELL, enumerationName);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	...
	public ConfigurationPage verifyErrorMsgForDuplicateEnumValue(String errorMessage) throws Exception {
		String NameMsg = GlobalController.brw.getText(this.TXT_ERROR_MESSAGE_ENUMERATION);
		System.out.println("Error Message Present On UI" + NameMsg);
		System.out.println("Error Message Provided in Test Data" + errorMessage);
	 ...
	 * @author Shashank
	 */
	public String editConfiguration(String existEnumName, String testDataSetName, String category) throws Exception {
	 ...
	 * @author Shashank
	 */
	public ConfigurationPage verifyDuplicateValueForEnumeration(String existEnumName, String testDataSetName, String category)
			throws Exception {
		String enumerationValue = TestData.read("PageConfiguration.xml", testDataSetName, "editEnumerationValue", category);
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage selectUsagePoolName(String usagePoolName) throws Exception {

		GlobalController.brw.selectListItem(this.LV_USAGE_POOL_NAME, usagePoolName);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	protected ConfigurationPage selectUsagePoolConsumptionNotification(String usagePoolConsumptionNotification) throws Exception {
		GlobalController.brw.selectDropDown(this.DD_usagePoolConsumptionNotification, usagePoolConsumptionNotification);
		return GlobalController.brw.initElements(ConfigurationPage.class);

	}

	protected ConfigurationPage selectusagePoolConsumptionNotification_Invoice(String usagePoolConsumptionNotification_Invoice)
			throws Exception {
		GlobalController.brw.selectDropDown(this.DD_usagePoolConsumptionNotification_Invoice, usagePoolConsumptionNotification_Invoice);
		return GlobalController.brw.initElements(ConfigurationPage.class);

	}

	protected ConfigurationPage selectusagePoolConsumptionNotification_Invoice_mail(String usagePoolConsumptionNotification_Invoice_mail)
			throws Exception {
		GlobalController.brw.selectDropDown(this.DD_usagePoolConsumptionNotification_Invoice_mail,
	 ...
	 * @throws Exception
	 */
	protected ConfigurationPage selectUsagePoolConsumptionFee(String usagePoolConsumptionFee) throws Exception {
		GlobalController.brw.selectDropDown(this.DD_usagePoolConsumptionFee, usagePoolConsumptionFee);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	public ConfigurationPage selectUsagePool(String usagePoolName) throws Exception {
	...
	public ConfigurationPage valdationMessageDisplay(String message) throws Exception {
		String msg = GlobalController.brw.getText(ConfigurationPage.STRONG_ERROR_MESSAGE1);
		if (TextUtilities.contains(msg, message)) {
			Assert.assertTrue(true);
		} else {
			throw new Exception("Test Case failed: ");
	...
	/**
	 * @author Syed
	 * @Description This method will click on Import MetaFields in Add
	 *              Information Type
	 */
	public ConfigurationPage clickOnImportMetafields() throws Exception {
		GlobalController.brw.clickLinkText(this.LNK_IMPORTMETAFIELDS);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage validateAccountInformationTypeSavedTestData(String data) throws Exception {
		GlobalController.brw.validateSavedTestData(this.TAB_ACCOUNT_TYPES_NAMES, data);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage validateAccountTypeSavedTestData(String data) throws Exception {
		GlobalController.brw.validateSavedTestData(this.TAB_ACCOUNT_TYPES_NAMES, data);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage clickAddedAccountType(String accountType) throws Exception {
		GlobalController.brw.selectListItem(this.TAB_ACCOUNT_TYPES_LIST_NAMES, accountType);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage clickMetaFieldCategory(String categoryName) throws Exception {
		GlobalController.brw.selectListItem(this.METAFIELD_CATEGORY, categoryName);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	...
	protected String getMetaFieldValidartionRuleValue() throws Exception {
		String metaFiledValue = GlobalController.brw.getText(this.DD_MD_VALIDATION);
	...
	public String addAccountType(String testDataSetName, String category) throws Exception {
	...
	public String addACHAccountType(String testDataSetName, String category, String TC_115_PAYMENT_METHOD_ACH) throws Exception {
		String accountTypeName = TestData.read("PageConfiguration.xml", testDataSetName, "accountTypeName", category);
		this.clickAddNewButton();
		this.setAccountTypeName(accountTypeName);
	...
	public void activateMetaFieldEditor() throws Exception {
		String cssClass = GlobalController.brw.getAttribute(this.LI_METAFIELDTAB_ACTIVATOR, "class");
		if (!cssClass.contains("active")) {
			GlobalController.brw.clickLinkText(this.SPAN_NEW_METAFIELDTAB);
		}
	}

	public String addAITMetaFieldToAccountType(String testDataSetName, String category, String accountType) throws Exception {
	...
	public String addrecurringPaymentMethodDetails(String testDataSetName, String category) throws Exception {
		String methodName = TestData.read("PageConfiguration.xml", testDataSetName, "methodName", category);
		String cardErrorMsg = TestData.read("PageConfiguration.xml", testDataSetName, "cardErrorMsg", category);
		String dateErrorMsg = TestData.read("PageConfiguration.xml", testDataSetName, "dateErrorMsg", category);
	...
	public String accounttype(String testDataSetName, String category, String method_types) throws Exception {
	...
	public ConfigurationPage SelectPaymentMethodTemplate(String testDataSetName, String category) throws Exception {
		String paymentTemplate = TestData.read("PageConfiguration.xml", testDataSetName, "paymentTemplate", category);
	...
	/**
	 * @author Syed
	 * @Description This method click on AccountType
	 */

	public ConfigurationPage ClickOnAccuntTypeInMetaField() throws Exception {
		GlobalController.brw.clickLinkText(this.LNK_ACCOUNTTYPE);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	protected ConfigurationPage verifyvalueFromDropDown(String metfieldAccountName) throws Exception {
		GlobalController.brw.getDropDownOptionIsPresent(this.DD_INCLUDE_NOTIFICATION, metfieldAccountName);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	ConfigurationPage setAccountNameOnSecondForm(String OrderTestData) throws Exception {
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage selectMetaFieldType(String metaFieldType) throws Exception {
		GlobalController.brw.selectDropDown(this.DD_METAFIELD_TYPE, metaFieldType);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage selectMetaFieldTypeOnSecondForm(String metaFieldType) throws Exception {
		GlobalController.brw.selectDropDown(this.DD_METAFIELD_TYPE2, metaFieldType);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	protected ConfigurationPage clickUpdateButtonOnSecondForm() throws Exception {
	...
	public ConfigurationPage verifyVelidityRulesDropDown(String testDataSetName, String category, String accountType) throws Exception {
		String accountName = TestData.read("PageConfiguration.xml", testDataSetName, "AccountName", category);
		this.clickOnAccountTypeLink();
		this.clickAddedAccountType(accountType);
		this.clickOnAddInformationType();
	...
	public ConfigurationPage verifyAddedMetafieldIsDisplayingIncludeNotificationDropDown(String accountType, String metfieldAccountName)
			throws Exception {
		this.clickOnAccountTypeLink();
		this.clickAddedAccountType(accountType);
		this.clickEditButton();
	...
	public ConfigurationPage verifyUsedMetafieldTypeIsDisplayedInDD(String testDataSetName, String category, String accountType)
			throws Exception {
		String nameEmail = TestData.read("PageConfiguration.xml", testDataSetName, "NameEmail", category);
		String metaFieldSelection = TestData.read("PageConfiguration.xml", testDataSetName, "MetafieldSelection", category);
		// this.clickAccountTypeLink();
	...
	public ConfigurationPage validateMetaFieldSelectionForCustomer() throws Exception {
		this.ClickOnMetaFieldLink();
		this.clickOnCustomerInMetaField();
		this.clickAddNewButton();
	...
	public ConfigurationPage validateMetaFieldSelectionForOrder() throws Exception {
		this.ClickOnMetaFieldLink();
	...
	public ConfigurationPage validateMetaFieldSelectionForPayment() throws Exception {
		this.ClickOnMetaFieldLink();
	...
	public ConfigurationPage verifyUserCannotSelectBothPaymentMethod(String accountType, String paymentAddress1, String paymentAddress2)
			throws Exception {
		this.clickOnAccountTypeLink();
		this.clickAddedAccountType(accountType);
		this.clickEditButton();
	 ...
	 * @throws Exception
	 */
	ConfigurationPage selectPaymentAddress(String paymentAddress) throws Exception {
		GlobalController.brw.selectDropDown(this.DD_INCLUDE_NOTIFICATION, paymentAddress);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	ConfigurationPage verifySelectedPaymentAddressOption(String paymentAddress) throws Exception {
		GlobalController.brw.getDropDownOptionIsSelected(this.DD_INCLUDE_NOTIFICATION, paymentAddress);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	public ConfigurationPage createCloneAccountType(String testDataSetName, String category, String accountTypeName) throws Exception {
	...
	public String addAccountTypeWithInvoiceDesign(String testDataSetName, String category) throws Exception {
		String accountTypeName = TestData.read("PageConfiguration.xml", testDataSetName, "AccountTypeName", category);
		String InvoiceDesign = TestData.read("PageConfiguration.xml", testDataSetName, "InvoiceDesign", category);
	...
	public ConfigurationPage reUpdatePreference(String testDataSetName, String category) throws Exception {
		String preference = TestData.read("PageConfiguration.xml", testDataSetName, "preference", category);
	...
	public ConfigurationPage adddNewOrderStatus(String testDataSetName, String category, boolean appliedCheckBox) throws Exception {
		...
		System.out.println("appliedCheckBox" + appliedCheckBox);
	...
	/**
	 * @author syed
	 * @Description This method will Select Account for Configuration
	 * @param accountTypeName
	 * @return
	 * @throws Exception
	 */
	public ConfigurationPage selectAccountNameForConfigure(String accountTypeName) throws Exception {
		GlobalController.brw.selectListItem(this.TAB_ACCOUNT_TYPES_LIST_NAMES, accountTypeName);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage addAccountTypePriceToSelectedProductWithCategory(String productCode, String addedAccount,
			String productCategory, String testDataSetName, String category) throws Exception {

		String productRate = TestData.read("PageConfiguration.xml", testDataSetName, "productRate", category);
		String startDate = TestData.read("PageConfiguration.xml", testDataSetName, "startDate", category);
		String expiryDate = TestData.read("PageConfiguration.xml", testDataSetName, "expiryDate", category);

		this.selectAccountNameForConfigure(productCategory);
		this.clickAccountTypePrices();
		this.selectProductInAccountTypePricesProductsTable(productCode, TextComparators.contains);
		this.clickAddPrice();
		System.out.println("productRate" + productRate);
		this.setAccountTypePriceRate(productRate);
		this.setStartDateInPrice(startDate);
		this.setExpiryDateInPrice(expiryDate);
		this.clickSaveChangesButton();
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	protected ConfigurationPage setStartDateInPrice(String startDate) throws Exception {
		GlobalController.brw.setText(this.TB_STARTDATE, startDate);

		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	protected ConfigurationPage setExpiryDateInPrice(String expiryDate) throws Exception {
		GlobalController.brw.setText(this.TB_EXPIRYDATE, expiryDate);
	...
	public void setOrderStatusOrder(String OrderQauntity) throws Exception {
		// fill ORDER
		GlobalController.brw.setText(this.TB_ORDERSTATUS_ORDERNUMBER, OrderQauntity);
	 ...
	 * @throws Exception
	 */
	protected ConfigurationPage checkApplieOrderdCheckBox(boolean appliedCheckBox) throws Exception {
	...
	public ConfigurationPage configureOrderChangeTypeWithMulitpleProduct(String testdataset, String category, boolean allowOrder,
	...
	public String configureOrderChangeTypeWithProduct(String testdataset, String category, boolean allowOrder, String selectProduct)
			throws Exception {
		String orderChangeName = TestData.read("PageConfiguration.xml", testdataset, "OrderName", category);
		this.clickOnOrderChangeType();
		this.clickAddNewButton();
		...
		this.setOrderChangeName(orderChangeName);
		this.allowOrderStatusChangeCheckbox(allowOrder);
		System.out.println("selectProduct1" + selectProduct);

		this.selectProductCategory_OrderChangeType(selectProduct);

		this.clickSaveChangesButton();
		return orderChangeName;
	}

	/**
	 * @author Syed
	 * @Description This method will add new account type in metafields
	 *
	 */
	public String addNewAccountTypeInMetaField(String testdataset, String category) throws Exception {
		String Name = TestData.read("PageConfiguration.xml", testdataset, "Name", category);
		this.ClickOnMetaFieldLink();
		this.ClickOnAccuntTypeInMetaField();
		this.clickAddNewButton();
		this.enterNewMetaDataName(Name);
		this.clickOnSaveChanges();
		return Name;
	 ...
	 * @throws Exception
	 */
	protected ConfigurationPage setOrderChangeName(String orderChangeName) throws Exception {
	 ...
	 * @throws Exception
	 */
	protected ConfigurationPage allowOrderStatusChangeCheckbox(Boolean allowOrder) throws Exception {
		if (allowOrder) {
	...
	protected ConfigurationPage selectProductCategory_OrderChangeType(String selectProduct) throws Exception {
		GlobalController.brw.selectDropDown(this.DD_SELECTPRODUCTCATEGORY, selectProduct);

		return GlobalController.brw.initElements(ConfigurationPage.class);

	}

	public ConfigurationPage configureOrderChangeTypeWithoutAllowStatusChange(String testdataset, String category, String selectProduct1,
	...
	public String createOrderPeriod(String testDataSetName, String category) throws Exception {
		String description = TestData.read("PageConfiguration.xml", testDataSetName, "description", category);
		String value = TestData.read("PageConfiguration.xml", testDataSetName, "value", category);
		String billingPeriod = TestData.read("PageConfiguration.xml", testDataSetName, "billingPeriod", category);
	...
	public String getDefaultCurrencyValue() throws Exception {
		String currentCurrency = GlobalController.brw.getDropDownSelectedValue(this.DD_DEFAULT_CURRENCY);
		return currentCurrency;
	}

	protected ConfigurationPage selectEuroCurrenyCheckBox(boolean currencyName) throws Exception {
		if (currencyName) {
	...
	protected ConfigurationPage setDefaultCurrencyValue(String targetValue) throws Exception {
		GlobalController.brw.selectDropDown(this.DD_DEFAULT_CURRENCY, targetValue);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will SetUpCurrency
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setCurrency(String testDataSetName, String category) throws Exception {
	...
	public ConfigurationPage resetCurrecncy(String testDataSetName, String category, String lastCurrencyName) throws Exception {
		boolean CurrencyNameCheckBox = TextUtilities.compareValue(
				TestData.read("PageConfiguration.xml", testDataSetName, "DisableCurrencyName", category), "true", true,
				TextComparators.equals);
		// this.selectEuroCurrenyCheckBox(CurrencyNameCheckBox);
		// this.clickSaveChangesButton();
	...
	/**
	 * This method will Click checkbox Euro
	 *
	 * @throws Exception
	 */
	public void currencyActiveEuro(boolean checkbox) throws Exception {
		if (checkbox) {
			GlobalController.brw.check(this.CHK_Euro);
		} else {
			GlobalController.brw.uncheck(this.CHK_Euro);
		}
	}

	/**
	 * This method will Click checkbox Pound
	 *
	 * @throws Exception
	 */
	public void currencyActivePoundSterling(boolean checkbox) throws Exception {
		if (checkbox) {
			GlobalController.brw.check(this.CHK_Pound_Sterling);
		} else {
			GlobalController.brw.uncheck(this.CHK_Pound_Sterling);
		}
	}

	/**
	 * This method will Click checkbox Won
	 *
	 * @throws Exception
	 */
	public ConfigurationPage currencyWon(boolean checkbox) throws Exception {
		if (checkbox) {
			GlobalController.brw.check(this.CHK_Won);
		} else {
			GlobalController.brw.uncheck(this.CHK_Won);
		}
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will Click checkbox Yen
	 *
	 * @throws Exception
	 */
	public void currencyActiveYen(boolean checkbox) throws Exception {
		if (checkbox) {
			GlobalController.brw.check(this.CHK_Yen);
		} else {
			GlobalController.brw.uncheck(this.CHK_Yen);
		}
	}

	/**
	 * This method will Save Currencies
	 *
	 * @throws Exception
	 */
	public ConfigurationPage clickSaveCurrencies() throws Exception {
		GlobalController.brw.click(this.LT_Save_generic);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This wrapper method will used to Click Check boxes in Currencies field
	 *
	 * @throws Exception
	 */
	public ConfigurationPage activeCurrency() throws Exception {
	...
	/**
	 * This method will unchecked Euro checkbox
	 *
	 * @throws Exception
	 */
	public ConfigurationPage deactivateCurrencies() throws Exception {
	...
	/**
	 * This method will setting up default currencies
	 *
	 * @throws Exception
	 */
	public String defaultcurrencysetup(String testDataSetName, String category) throws Exception {
	...
	/**
	 * This method will select default curencies dropdown
	 *
	 * @throws Exception
	 */
	public ConfigurationPage defaultCurrency(String defaultvalue) throws Exception {
		GlobalController.brw.selectDropDown(this.DP_Currency_Default, defaultvalue);
		return GlobalController.brw.initElements(ConfigurationPage.class);

	}

	/**
	 * This wrapper method is to fill form in Seller Company
	 *
	 * @throws Exception
	 */
	public ConfigurationPage CreateSellerCompany(String testDataSetName, String category) throws Exception {
	...
	/**
	 * This method will click in Seller company button
	 *
	 * @throws Exception
	 */
	public ConfigurationPage clickCreateSeller() throws Exception {

		GlobalController.brw.click(this.bttn_CreateSeller);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will click in login button
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setSellerLoginName(String loginName) throws Exception {

		GlobalController.brw.setText(this.txt_Loginname, loginName);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage setSellerFirstName(String firstname) throws Exception {

		GlobalController.brw.setText(this.txt_Firstname, firstname);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will set seller last Name
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setSellerLastName(String lastname) throws Exception {

		GlobalController.brw.setText(this.txt_Lasttname, lastname);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage setSellerFirstNumber(String number) throws Exception {

		GlobalController.brw.setText(this.txt_Firstphone, number);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will set seller Country
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setsSllerConuntryCode(String conuntrycode) throws Exception {

		GlobalController.brw.selectDropDown(this.drp_ConuntryCode, conuntrycode);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will set Contact Number
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setSellerContactPhoneNumber(String number) throws Exception {

		GlobalController.brw.setText(this.txt_ContactPhoneNumber, number);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will set seller Phone Area Code
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setSellerPhoneAreaCode(String number) throws Exception {

		GlobalController.brw.setText(this.txt_PhoneAreaCode, number);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will set seller Email
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setSellerEmail(String email) throws Exception {

		GlobalController.brw.setText(this.txt_Email, email);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will set seller Organization
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setSellerOrganization(String Organization) throws Exception {

		GlobalController.brw.setText(this.txt_Organization, Organization);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will set Address
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setsellerAddress1(String address1) throws Exception {

		GlobalController.brw.setText(this.txt_Address1, address1);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will set seller State
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setSellerStateProvince(String StateProvince) throws Exception {

		GlobalController.brw.setText(this.txt_StateProvince, StateProvince);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will set seller zipcode
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setSellerZipPostalCode(String ZipPostalCode) throws Exception {

		GlobalController.brw.setText(this.txt_ZipPostalCode, ZipPostalCode);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will seller Save seller
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setSellerSave() throws Exception {

		GlobalController.brw.click(this.bttn_SaveChangesSeller);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This wrapper method will Add AIT meta type
	 *
	 * @throws Exception
	 */
	public String addAITMetaFiledToAccountType(String testDataSetName, String category, String accountType) throws Exception {
		...
		this.clickAddedAccountType(accountType);
		this.clickOnAddInformationType();
		this.setInvoiceName(accountName);
		this.clickAddNewMetaField();
		this.selectMetaFieldType(metaFieldSelection);
		this.ClickOnMetaFieldBar();
		this.setAccountName(nameEmail);
		this.selectMetaFieldType(metaFieldSelection);
		this.clickUpdateButton();
		this.clickSaveChangesButton();
	...
	/**
	 * This method will click in metafield id
	 *
	 * @throws Exception
	 */
	public ConfigurationPage clickOnMetafieldID() throws Exception {
		GlobalController.brw.clickLinkText(this.tab_METAFIELDID);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will click in Edit Metafield id
	 *
	 * @throws Exception
	 */
	...
	/**
	 * This method will click in userNotification
	 *
	 * @throws Exception
	 */
	public void clickUserNotification(boolean checkbox) throws Exception {
		GlobalController.brw.check(this.chk_UserNotification_AccntType);
	}

	public ConfigurationPage popupYesAit() throws Exception {
		GlobalController.brw.click(this.bttn_yes_PopupAIT);
		return GlobalController.brw.initElements(ConfigurationPage.class);

	}

	/**
	 * This method will verify dropdown value
	 *
	 * @throws Exception
	 */
	public ConfigurationPage verifyDropdownIncludeinNotifications(String value) throws Exception {

		GlobalController.brw.isValuePresentInDropDown(this.drp_Include_in_Notifications, value);

		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will click Payment Notification
	 *
	 * @throws Exception
	 */
	public ConfigurationPage clickPaymentnotification(String metaFieldName) throws Exception {
		GlobalController.brw.waitForElement(this.lnk_payment, 5000);
		GlobalController.brw.selectListItem(this.lnk_payment, metaFieldName);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will click Created Payment Notification
	 *
	 * @throws Exception
	 */
	public ConfigurationPage createPaymentNotification(String testdata, String category) throws Exception {
	...
	/**
	 * This method will click Add Notification button
	 *
	 * @throws Exception
	 */
	public ConfigurationPage addpaymentnotification() throws Exception {

		GlobalController.brw.click(this.bttn_AddPaymentNotification);

		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method set Payment Notification
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setPaymentNotification(String desc) throws Exception {

		GlobalController.brw.setText(this.txt_AddPaymentNotificationdec, desc);
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage setPaymentNotificationSave() throws Exception {
		GlobalController.brw.click(this.bttn_NotificationSaveChanges);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This wrapper method Set and Save Notification
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setEditAndVerifyValuePresent(String testDataSetName, String category) throws Exception {
	...
	/**
	 * This method Recently created Notification
	 *
	 * @throws Exception
	 */
	public ConfigurationPage clickRecentPaymentNotification() throws Exception {

		GlobalController.brw.click(this.lnk_recent_Notification);
		return GlobalController.brw.initElements(ConfigurationPage.class);

	}

	/**
	 * This method Recently Edit Notification
	 *
	 * @throws Exception
	 */
	public ConfigurationPage clickEditPaymentNotification() throws Exception {

		GlobalController.brw.click(this.bttn_Edit_PaymentNotification);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage verifyEmail(String value) throws Exception {

		GlobalController.brw.isValuePresentInDropDown(this.lst_Payment_value, value);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage clickpopupyes() throws Exception {

		GlobalController.brw.click(this.bttn_delte_AITType);
		return GlobalController.brw.initElements(ConfigurationPage.class);

	}

	/**
	 * This method Verify Email Notification
	 *
	 * @throws Exception
	 */
	public ConfigurationPage verifyerrormessage() throws Exception {
	...
	/**
	 * This method Copy Company Created
	 *
	 * @throws Exception
	 */
	public ConfigurationPage copyCompanyCreated() throws Exception {

		this.clickOnComapanyLink();
		this.clickCopyCompanyButton();
		this.markCompanyAsChildCompany(true);
		this.setChild_ExtractedCompanyName();
		this.clickConfirmPopupYesButton();
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method Extract Company Name and Set in Text box
	 *
	 * @throws Exception
	 */
	public ConfigurationPage setChild_ExtractedCompanyName() throws Exception {
		String getcompanydesc = GlobalController.brw.getText(this.lb_Comapnyname);
		GlobalController.brw.setText(this.TB_TEMPLATE_COMPANY_NAME, getcompanydesc);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method uncheck currency
	 *
	 * @throws Exception
	 */
	public ConfigurationPage unusedcurrency() throws Exception {
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage setUserName(String userName) throws Exception {
		GlobalController.brw.setText(this.TB_USER_LOGIN, userName);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will set User Email
	 *
	 * @author shanky
	 * @throws Exception
	 */
	public ConfigurationPage setUserEmail(String email) throws Exception {
		GlobalController.brw.setText(this.TB_EMAIL, email);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will select User User
	 *
	 * @author shanky
	 * @throws Exception
	 */

	public ConfigurationPage selectUser(String userName) throws Exception {
		GlobalController.brw.selectListItem(this.TAB_USER, userName);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will Clcik on Permission Button
	 *
	 * @author shanky
	 * @throws Exception
	 */

	public ConfigurationPage clickOnPermissionButton() throws Exception {
		GlobalController.brw.clickLinkText(this.BT_PERMISSIONS);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will Clcik on User Code Button
	 *
	 * @author shanky
	 * @throws Exception
	 */

	public ConfigurationPage clickOnUserCodeButton() throws Exception {
		GlobalController.brw.clickLinkText(this.BT_USER_CODE);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * Enable Include Notification check box
	 *
	 * @author shanky
	 * @param notification
	 * @return
	 * @throws Exception
	 */
	protected ConfigurationPage enableIncludeNotificationCheckBox(boolean notification) throws Exception {
		if (notification) {
			GlobalController.brw.check(this.CB_INCLUDE_NOTIFICATION);
		} else {
			GlobalController.brw.uncheck(this.CB_INCLUDE_NOTIFICATION);
		}
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * Enable Include View User Code check box
	 *
	 * @author shanky
	 * @param notification
	 * @return
	 * @throws Exception
	 */
	protected ConfigurationPage enableViewUserCodeCheckBox(boolean viewUserCode) throws Exception {
		if (viewUserCode) {
			GlobalController.brw.check(this.CB_VIEW_USER_CODE);
		} else {
			GlobalController.brw.uncheck(this.CB_VIEW_USER_CODE);
		}
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * Enable Include Edit User Code check box
	 *
	 * @author shanky
	 * @param notification
	 * @return
	 * @throws Exception
	 */
	protected ConfigurationPage enableEditUserCodeCheckBox(boolean editUserCode) throws Exception {
		if (editUserCode) {
			GlobalController.brw.check(this.CB_EDIT_USER_CODE);
		} else {
			GlobalController.brw.uncheck(this.CB_EDIT_USER_CODE);
		}
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * Enable Include Modify User Code check box
	 *
	 * @author shanky
	 * @param notification
	 * @return
	 * @throws Exception
	 */
	protected ConfigurationPage enableModifyUserCodeCheckBox(boolean modifyUserCode) throws Exception {
		if (modifyUserCode) {
			GlobalController.brw.check(this.CB_MODIFY_USER_CODE);
		} else {
			GlobalController.brw.uncheck(this.CB_MODIFY_USER_CODE);
		}
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * Enable Include Assign User Code check box
	 *
	 * @author shanky
	 * @param notification
	 * @return
	 * @throws Exception
	 */
	protected ConfigurationPage enableAssignUserCodeCheckBox(boolean assignUserCode) throws Exception {
		if (assignUserCode) {
			GlobalController.brw.check(this.CB_ASSIGN_USER_CODE);
		} else {
			GlobalController.brw.uncheck(this.CB_ASSIGN_USER_CODE);
		}
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * Enable Include Add User Code check box
	 *
	 * @author shanky
	 * @param notification
	 * @return
	 * @throws Exception
	 */
	protected ConfigurationPage enableAddUserCodeCheckBox(boolean addUserCode) throws Exception {
		if (addUserCode) {
			GlobalController.brw.check(this.CB_ADD_USER_CODE);
		} else {
			GlobalController.brw.uncheck(this.CB_ADD_USER_CODE);
		}
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will set User Code
	 *
	 * @author shanky
	 * @throws Exception
	 */

	public ConfigurationPage setUserCode(String userCode) throws Exception {
		GlobalController.brw.setText(this.TB_USER_CODE, userCode);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will select option from Type DropDown
	 *
	 * @author shanky
	 * @throws Exception
	 */

	public ConfigurationPage selectTypeValue(String targetValue) throws Exception {
		GlobalController.brw.selectDropDown(this.DD_TYPE, targetValue);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will set Date Valid to
	 *
	 * @author shanky
	 * @throws Exception
	 */

	public ConfigurationPage setValieDate(String validDate) throws Exception {
		GlobalController.brw.setText(this.TB_VALIDTO, validDate);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	...
	public ConfigurationPage setDescription(String description) throws Exception {
		GlobalController.brw.setText(this.TA_DESCRIPTION, description);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * Thie method will click on Add new Button
	 *
	 * @author shanky
	 * @return
	 * @throws Exception
	 */
	protected ConfigurationPage clickAddNew() throws Exception {
		GlobalController.brw.clickLinkText(this.BT_ADDNEW);
	 ...
	 * @throws Exception
	 */
	public String createUser(String testDataSetName, String category) throws Exception {
		String userName = TestData.read("PageConfiguration.xml", testDataSetName, "userName", category);
		String email = TestData.read("PageConfiguration.xml", testDataSetName, "email", category);
		boolean notification = TextUtilities.compareValue(
				TestData.read("PageConfiguration.xml", testDataSetName, "notification", category), "true", true, TextComparators.equals);
		...
		this.enableIncludeNotificationCheckBox(notification);
		this.clickSaveChangesButton();
		return userName;
	}

	/**
	 * This method will enable user code values in permission for user
	 *
	 * @author shanky
	 * @param testDataSetName
	 * @param category
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage setPermission(String testDataSetName, String category, String userName) throws Exception {
		boolean addUserCode = TextUtilities.compareValue(TestData.read("PageConfiguration.xml", testDataSetName, "addUserCode", category),
				"true", true, TextComparators.equals);
		boolean assignUserCode = TextUtilities.compareValue(
				TestData.read("PageConfiguration.xml", testDataSetName, "assignUserCode", category), "true", true, TextComparators.equals);
		boolean editUserCode = TextUtilities.compareValue(
				TestData.read("PageConfiguration.xml", testDataSetName, "editUserCode", category), "true", true, TextComparators.equals);
		boolean viewUserCode = TextUtilities.compareValue(
				TestData.read("PageConfiguration.xml", testDataSetName, "viewUserCode", category), "true", true, TextComparators.equals);
		boolean modifyUserCode = TextUtilities.compareValue(
				TestData.read("PageConfiguration.xml", testDataSetName, "modifyUserCode", category), "true", true, TextComparators.equals);

		this.selectUser(userName);
		this.clickOnPermissionButton();
		this.enableAddUserCodeCheckBox(addUserCode);
		this.enableAssignUserCodeCheckBox(assignUserCode);
		this.enableEditUserCodeCheckBox(editUserCode);
		this.enableViewUserCodeCheckBox(viewUserCode);
		this.enableModifyUserCodeCheckBox(modifyUserCode);
		this.clickSaveChangesButton();
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will enter user code
	 *
	 * @author shanky
	 * @param testDataSetName
	 * @param category
	 ...
	 * @throws Exception
	 */
	public String enterUserCode(String testDataSetName, String category, String userName) throws Exception {
		String userCode = TestData.read("PageConfiguration.xml", testDataSetName, "userCode", category);
		String validDate = TestData.read("PageConfiguration.xml", testDataSetName, "validDate", category);
		String description = TestData.read("PageConfiguration.xml", testDataSetName, "description", category);

		this.selectUser(userName);
		this.clickOnUserCodeButton();
		this.clickAddNew();
		this.clickSaveChangesButton();
		this.verifySuccessfulErrorMessage();
		this.setUserCode(userCode);
		this.setValieDate(validDate);
	...
	/**
	 * This method will add enumeration value
	 *
	 * @author shanky
	 * @param existEnumName
	 * @param testDataSetName
	 ...
	 * @throws Exception
	 */
	public String addEnumerations(SetEnumValues existEnumName, String testDataSetName, String category) throws Exception {
		String enumerationName = TestData.read("PageConfiguration.xml", testDataSetName, "enumerationName", category);
		String enumerationValue = TestData.read("PageConfiguration.xml", testDataSetName, "enumerationValue", category);
		this.clickAddNew();
		this.setEnumerationName(enumerationName);
	...
	/**
	 * This method will edit user code
	 *
	 * @author shanky
	 * @param testDataSetName
	 * @param category
	 ...
	 * @throws Exception
	 */
	public String editUserCode(String testDataSetName, String category, String userName, String userNameCode) throws Exception {
		String userCode = TestData.read("PageConfiguration.xml", testDataSetName, "userCode", category);

		this.selectUser(userName);
		this.clickOnUserCodeButton();
		this.selectUser(userNameCode);
		this.clickEditButton();
		this.setUserCode(userCode);
		this.clickSaveChangesButton();
		return userName + userCode;
	...
	/**
	 * This method will get user name with code
	 *
	 * @author shanky
	 * @return
	 * @throws Exception
	 */
	public String getUserNameWithCode() throws Exception {
		String userNameCode = GlobalController.brw.getText(this.ADDED_USER_CODE);
		return userNameCode;
	}

	/**
	 * This method will verify user code
	 *
	 * @author shanky
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage verifyUserCode(String expectedUserName) throws Exception {
		String actualUserName = this.getUserNameWithCode();
	...
	/**
	 * This method will Click on Order Change Type link
	 *
	 * @author Shanky
	 * @throws Exception
	 */

	public ConfigurationPage ClickOnOrderChangeTypeLink() throws Exception {
		GlobalController.brw.clickLinkText(this.LT_ORDER_CHANGE_TYPE);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method will Set Order Change Type name
	 *
	 * @throws Exception
	 */

	public ConfigurationPage setOrderChangeStatusName(String name) throws Exception {
		GlobalController.brw.setText(this.ORDER_STATUS_TYPE_NAME, name);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * Check Allow Order to change
	 *
	 *
	 */
	protected ConfigurationPage enableAllowOrderToChnage(boolean value) throws Exception {
		if (value) {
			GlobalController.brw.check(this.CB_ALLOW_ORDER_STATUS_CHANGE);
		} else {
			GlobalController.brw.uncheck(this.CB_ALLOW_ORDER_STATUS_CHANGE);
		}
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage selectCategory(String category) throws Exception {
	...
	/**
	 * This order will Add order Status Type
	 *
	 * @param testDataSetName
	 * @param category
	 * @param category1
	 ...
	 * @throws Exception
	 */
	public ConfigurationPage addOrderStatusType(String testDataSetName, String category, String category1, String category2)
			throws Exception {
		String name = TestData.read("PageConfiguration.xml", testDataSetName, "name", category);
		boolean value = TextUtilities.compareValue(TestData.read("PageConfiguration.xml", testDataSetName, "value", category), "true",
				true, TextComparators.equals);
		this.clickAddNewButton();
		this.setOrderChangeStatusName(name);
		this.enableAllowOrderToChnage(value);
		GlobalController.brw.pressControlKey();
		this.selectCategory(category1);
		this.selectCategory(category2);
	...
	/**
	 * This wrapper method will unchecked Currency Yen and save it
	 *
	 * @throws Exception
	 */
	public ConfigurationPage unusedCurrency() throws Exception {
	...
	/**
	 * This method will DeleteAit button
	 *
	 * @throws Exception
	 */
	public ConfigurationPage clickDeleteAit() throws Exception {

		GlobalController.brw.clickLinkText(this.bttn_Delete_AITType);
		return GlobalController.brw.initElements(ConfigurationPage.class);

	}

	/**
	 * This method click in button delete
	 *
	 * @throws Exception
	 */
	public ConfigurationPage clickPopupYes() throws Exception {
	 ...
	 * @throws Exception
	 */
	protected ConfigurationPage verifySuccessfulMessage() throws Exception {
		MessagesPage.isIntermediateSuccessMessageAppeared();
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}

	/**
	 * This method is add account
	 *
	 * @author Shanky
	 * @param testDataSetName
	 * @param category
	 ...
	 * @throws Exception
	 */
	public String addAccount(String testDataSetName, String category, String paymentMethod) throws Exception {
		String name = TestData.read("PageConfiguration.xml", testDataSetName, "name", category);
		this.clickAddNew();
		this.selectPaymentMethodTypes(paymentMethod);
