...
public class MessagesPage {
	...
	@LocateBy(xpath = "//div[@class='msg-box error']/ul/li")
	private static ElementField STRONG_VALIDATION_MESSAGE;
	...
	public static boolean isValidationMessageAppeared() throws Exception {
		Assert.assertTrue(GlobalController.brw.isElementPresent(MessagesPage.STRONG_VALIDATION_MESSAGE));
		return GlobalController.brw.isElementPresent(MessagesPage.STRONG_VALIDATION_MESSAGE);
	}
